# SPECCHIO Programming Course - Promoted by [COST OPTIMISE Workshop WG1](http://optimise.dcs.aber.ac.uk/working-groups/wg1-spectral-information-system/events/)

SPECCHIO Programming Course Material is provided via the links below.

![COST](./_img/COST_Logo.png)
...
## Code Examples for Matlab and R

 - [SPECCHIO Interactive Sandbox GUI](http://uk.mathworks.com/matlabcentral/fileexchange/48082-specchio-interactive-sandbox-gui--)
 - [SPECCHIO Fluspect GUI Matlab Code](http://uk.mathworks.com/matlabcentral/fileexchange/60451-specchio-fluspect-gui)
